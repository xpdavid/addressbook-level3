...
`* * *` | user | edit a person's information | update people's information if they change their contacts
`* *` | user | hide [private contact details](#private-contact-detail) by default | to minimize chance of someone else seeing them by accident
`* *` | user with many persons in the address book | show people under specific tag | to easily find people labeled as friend, colleague, etc.
`* *` | user with many persons in the address book | find people based on their contacts | easily find people if user can only remember some of the contacts
`*` | user | delete tag | to clear unused tags
`*` | user | merge two tags | to combine people under similar tags
